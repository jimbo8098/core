...
//Basic variables
$name="Staff Attendance" ; //The name of the variable as it appears to users. Needs to be unique to installation. Also the name of the folder that holds the unit.
$description="View and edit staff attendance" ; //Short text description
$entryURL="staff_attendance.php" ; //The landing page for the unit, used in the main menu
$type="Additional" ; //Do not change.
$category="People" ; //The main menu area to place the module in
$version="0.0.01" ; //Verson number
$author="Jim Speir" ; //Your name
$url="" ; //Your URL

//Module tables
$moduleTables[0]="CREATE TABLE `gibbonStaffAttendance` (
  `gibbonStaffAttendanceID` INT(11) NOT NULL,
    `gibbonStaffID` INT(10) UNSIGNED ZEROFILL NOT NULL,
      `gibbonAttendanceCodeID` INT(3) UNSIGNED ZEROFILL NOT NULL,
        `notes` TEXT NOT NULL,
          `startDate` DATETIME NOT NULL,
            `endDate` DATETIME NOT NULL,
              PRIMARY KEY (`gibbonStaffAttendanceID`),
                INDEX `gibbonStaffID` (`gibbonStaffID`),
                  INDEX `gibbonAttendanceCodeID` (`gibbonAttendanceCodeID`)
                  )
...
$actionRows[0]["entryURL"]="staff_attendance.php" ; //The landing action for the page.
